  ...
  <body>
      ...
      <div id='cssmenu'>
        <ul>
           ...
           <li><a href='https://www.mibph.org/facts.php'><i class="fas fa-random"></i> Random Seal facts</a></li>
        ...
        <footer class="animate__animated animate__fadeInUp">
          ...
          <p class="smol">All Seal facts are stored at our Seal Database, which pulls facts from various websites.</p>
          <p class="smol">While we try to fact check each quote, please understand that newer ones might not have been checked yet.</p>
          <p class="smol">A list with websites that we pull the facts from into our Database will be coming soon.</p>
        </footer>
